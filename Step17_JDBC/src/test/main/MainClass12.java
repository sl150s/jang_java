...
public class MainClass12 {
   ...
   public static List<MemberDto> getList(){
	   ...
	   //회원 전체 목록을 담을 ArrayList 객체를 생성해서 참조값을 List 인텊이스 type으로 담기
      ...
      ResultSet rs=null;
      try {
         //Connection 객체의 참조값 얻어오기 //DBconnect라는 클래스의 getConn 메소드 객체 conn에 객체값주기
         ...
         //prepareStatement는 sql 구문을 실해는 역할에서 기능향상, 
